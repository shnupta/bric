 ...
 */
void
disable_raw_mode (int fd, struct termios *termios,
 ...
 */
int
enable_raw_mode (int fd, struct termios *termios,
                 struct editor_config *editor)
{
  struct termios raw;
 ...
 */
int
get_cursor_pos (int ifd, int ofd, int *rows, int *columns)
{
  char buf[32];
  unsigned int i = 0;
 ...
 */
int
get_window_size (int ifd, int ofd, int *rows, int *columns)
{
  struct winsize ws;
